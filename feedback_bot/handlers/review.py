...
async def cmd_start(message: Message):
    ...
    text = (
        ...
        "вы получите <b>3 дня статуса x2</b>!\n\n"
        "✨ Пользователи с x2 статусом получают <b>100% вакансий</b>, "
        "обычные пользователи — <b>90%</b>.\n\n"
...
async def cmd_review(message: Message, state: FSMContext):
    ...
    try:
        ...
        if all_user_reviews:
            await message.answer(
                ...
                "За одобренный отзыв вы получите <b>3 дня x2 статуса</b>.\n\n"
    ...
    text = (
        ...
        "💡 <b>Важно:</b> Отзыв пройдет модерацию. За одобренный отзыв вы получите <b>3 дня x2 статуса</b>!\n\n"
        "⚠️ Каждый пользователь может оставить только один отзыв.\n\n"
        "Для отмены — /cancel"
    )
...
async def receive_review_rating(message: Message, state: FSMContext):
    ...
    if review:
        ...
        await message.answer(
            ...
            "После одобрения вы получите <b>3 дня x2 статуса</b>.\n\n"
...
async def cmd_help(message: Message):
    ...
    text = (
        ...
        "⚠️ Каждый пользователь может оставить только один отзыв.\n\n"
        "<b>Что такое x2 статус?</b>\n"
        "Пользователи с x2 получают <b>100% вакансий</b>, "
        "обычные пользователи — <b>90%</b>."
    )
